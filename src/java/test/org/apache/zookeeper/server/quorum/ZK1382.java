...
public class ZK1382 {
	...
	protected static final Logger LOG = LoggerFactory.getLogger(ZK1382.class);
	...
	private ByteBuffer createWatchesMessage() {
		...
		h.setXid(-8);
		Packet p = new Packet(h, new ReplyHeader(), sw, null, null);
		return p.createBB();
	}
	...
	private ByteBuffer createConnRequest() {
		...
		Packet packet = new Packet(null, null, conReq, null, null, false);
		return packet.createBB();
	}
